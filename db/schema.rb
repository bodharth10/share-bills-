...
ActiveRecord::Schema.define(version: 20160820115854) do
  ...
  create_table "expenses", force: :cascade do |t|
    ...
    t.date     "exp_date"
    t.decimal  "total_amount",             precision: 2, scale: 1, default: 0.0
    t.datetime "created_at",                                                      null: false
    t.datetime "updated_at",                                                      null: false
  end

  create_table "individual_expenses", force: :cascade do |t|
